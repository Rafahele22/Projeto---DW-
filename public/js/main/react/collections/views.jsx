const { API_BASE, AlbumPreview, useFontsFromCollection } = window.CollectionsHooks || {};
const { ListItem, GridItem, PairsCard } = window.CollectionsItems || {};
